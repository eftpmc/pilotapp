...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn('dropdown-menu-item', inset && 'inset', className)}
    {...props}
  >
    {children}
    <ChevronRight size={14} className="dropdown-menu-sub-chevron" />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn('dropdown-menu-item', inset && 'inset', destructive && 'destructive', className)}
    {...props}
  />
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn('dropdown-menu-item checkbox', className)}
    checked={checked}
    {...props}
  >
  ...
  >
    <span className="dropdown-menu-indicator">
      <DropdownMenuPrimitive.ItemIndicator>
        <span style={{ width: 7, height: 7, borderRadius: '50%', background: 'currentColor', display: 'block' }} />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('dropdown-menu-label', inset && 'inset', className)}
    {...props}
  />
))
